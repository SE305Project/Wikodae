...
function query1($input){
	...
	$query = "select entity.entity_id, entity.entity_text, description.desc_text 
			...
			where entity_text='".$input."' and entity_language='en' 
...
function query2($input){
	...
	$query = "select entity.entity_text, entity.entity_id, mainsnak.property_id, entity_language
			...
			and entity.entity_id in (
			    ...
			    where wkb.snak_id=mainsnak.snak_id) and entity_language='en'
...
function query4_properties($input){
	$con = connect_db();
...
function query4_statements($input){
	$con = connect_db();
	$query = "select snak.snak_id, snak.entity_id, des.desc_text, ent.entity_text
			...
			and ent.entity_text='".$input."' and ent.entity_language='en'
